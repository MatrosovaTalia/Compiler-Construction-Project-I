...
public class EqualsOperation implements IExpression {
    ...
    public EqualsOperation(String operation, IExpression left, IExpression right){
        this.left = left;
        this.right = right;
    ...
    public void emit(ClassWriter cw, MethodVisitor mv, String methodName) {
        ...
        if (left_exp.equals("I") && right_exp.equals("I")) {
            ...
            throw new RuntimeException("Illegal expression: Comparison operation does not compare integer and double value");
        }
